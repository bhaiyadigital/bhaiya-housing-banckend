            ...
            <div class="card card-success card-outline mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="projectSlug" required
                                value="{{ $content->name }}" placeholder="url-friendly-name">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="short" class="form-select" required>
                                ...
                                <option value="Residential" {{ $content->short === 'Residential' ? 'selected' : '' }}>
                                    Residential</option>
                                <option value="Commercial" {{ $content->short === 'Commercial' ? 'selected' : '' }}>
                                    Commercial</option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="extra_status" id="extraStatus" class="form-select form-select-sm">
                                            <option value="ongoing"
                                                {{ ($extra['status'] ?? '') === 'ongoing' ? 'selected' : '' }}>Ongoing
                                            </option>
                                            <option value="upcoming"
                                                {{ ($extra['status'] ?? '') === 'upcoming' ? 'selected' : '' }}>Upcoming
                                            </option>
                                            <option value="complete"
                                                {{ ($extra['status'] ?? '') === 'complete' ? 'selected' : '' }}>Complete
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div id="sizeRows">
                                            ...
                                            @foreach ($sizes as $sz)
                                                <div class="size-row d-flex gap-2 mb-2 align-items-center">
                                                    <input type="text" name="extra_size[]"
                                                        class="form-control form-control-sm" value="{{ $sz }}"
                                            ...
                                            <div class="size-row d-flex gap-2 mb-2 align-items-center">
                                                <button type="button" class="btn btn-sm btn-outline-success w-100"
                                                    onclick="addSizeRow()">+ Add Type</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label small">Building Height</label>
                                        <input type="text" name="extra_height" id="extraHeight"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="extra_featured" id="extraFeatured"
                                            class="form-select form-select-sm">
                                            <option value="false" {{ empty($extra['featured']) ? 'selected' : '' }}>No
                                            </option>
                                            <option value="true" {{ !empty($extra['featured']) ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            @if ($content->video_path)
                                <div class="mb-2">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <div class="badge bg-secondary d-block mb-1">
                                                {{ basename($content->video_path) }}</div>
                                            <div class="form-check mb-0">
                                                <input class="form-check-input border-danger" type="checkbox"
                                                    name="delete_video" id="deleteVideo" value="1"
                                                    onchange="toggleShade('videoCurrentPreview', this)">
                                                <label class="form-check-label text-danger small"
                                                    for="deleteVideo">Delete</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                ════════════════════════════════════════════════════════════ --}}
                    <div class="mb-3">
                                ...
                                @foreach ($imgPaths as $i => $img)
                                   ...
                                   border:1px solid #dee2e6; border-radius:6px; background:#fff; overflow:visible;">
                                       ...
                                       border-radius:5px 5px 0 0; display:block; pointer-events:none;">
                                        ...
                                        <div
                                            class="form-check mb-1 d-flex justify-content-center gap-1 align-items-center">
                                            <input class="form-check-input border-danger" type="checkbox"
                                                name="delete_images[]" value="{{ $i }}"
                                                id="delImg{{ $i }}"
                                                onchange="toggleExistingDelete(this, {{ $i }})">
                                            <label class="form-check-label text-danger" style="font-size:11px;"
                                                for="delImg{{ $i }}">Delete</label>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <input type="file" id="multiInput" name="img_paths[]" multiple accept="image/*"
                            style="display:none">
                    ...
                    <div class="card border mt-3">
                        <div class="card-header bg-light py-2 cursor-pointer" data-bs-toggle="collapse"
