 ...
 @section('meta')
     @php
         ...
         $pImg = $project->img_path
             ? asset($project->img_path)
             : (isset($imgPaths[0])
                 ? $imgPaths[0]
                 : asset($setting->img_path ?? 'assets/images/logo.png'));
     @endphp

     @include('partials.meta', [
         'pageKey' => 'projects',
         'title' => $project->meta_title ?? $project->title,
         'description' => $project->meta_description ?? $project->short,
     ...
     <section class="relative z-10 w-full" style="background:#ffffff; font-family:'Jost',sans-serif;">
         ...
         <div class="container mx-auto px-6 lg:px-14 py-20">
             <div class="flex flex-col md:flex-row gap-16 items-start">
                 ...
                 <!-- Right: Image -->
                 <div class="hidden md:block md:w-1/3 h-[350px] md:h-[600px] relative scroll-move" data-axis="Y"
                     style="margin-top: -20%;z-index:100">
                     <img src="{{ $imgPaths[1] ?? '' }}" alt="{{ $project->title }}"
                         class="w-full object-cover shadow-2xl" style="height: clamp(500px, 70vh, 800px);"
             ...
             <div class="container mx-auto px-6 lg:px-14">
                 <div class="relative flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                     ...
                     <div class="relative w-full md:w-1/2">
                         <img src="{{ $imgPaths[2] ?? '' }}" alt="Gallery 1" class="w-full object-cover shadow-lg"
                     ...
                     <!-- Right Image -->
                     <div class="relative w-full md:w-1/2">
                         <img src="{{ $imgPaths[3] ?? '' }}" alt="Gallery 2" class="w-full object-cover shadow-lg"
                             style="height: clamp(220px, 40vw, 500px);"
         ...
         <div class="relative z-10 container mx-auto px-6 lg:px-14 pt-16 pb-0">
             ...
             <div class="w-full" style="border-top:1px solid rgba(255,255,255,0.15);">
                 ...
                 <div class="flex" style="border-bottom:1px solid rgba(255,255,255,0.15);">
                     ...
                     <!-- Spacious Apartments -->
                     <div class="flex-1 flex flex-col justify-between py-10 pr-8 hover:bg-white/5 transition-all duration-300 cursor-pointer"
                         style="border-right:1px solid rgba(255,255,255,0.15);">
                         <svg class="w-8 h-8 mb-16 opacity-80" viewBox="0 0 32 32" fill="none" stroke="white"
                     ...
                     <!-- Smart Access -->
                     <div class="flex-1 flex flex-col justify-between py-10 px-8 hover:bg-white/5 transition-all duration-300 cursor-pointer"
                         style="border-right:1px solid rgba(255,255,255,0.15);">
                         <svg class="w-8 h-8 mb-16 opacity-80" viewBox="0 0 32 32" fill="none" stroke="white"
                             stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex-1 flex flex-col justify-between py-10 px-8 hover:bg-white/5 transition-all duration-300 cursor-pointer"
                         ...
                         <p class="text-white text-xs font-light uppercase opacity-80"
                             style="letter-spacing:0.1em; line-height:1.8;">Children's Play Area &amp;<br />Easy City
                             Access</p>
                     </div>
                     ...
                     <div
                         ...
                         <p class="text-white text-xs font-light uppercase opacity-80"
                             style="letter-spacing:0.1em; line-height:1.8;">Walking Paths &amp;<br />Landscaped
                             Surroundings</p>
                     </div>
                 ...
                 <div class="flex">
                     ...
                     <div class="flex-1 flex flex-col justify-between py-10 px-8 hover:bg-white/5 transition-all duration-300 cursor-pointer"
                         ...
                         <p class="text-white text-xs font-light uppercase opacity-80"
                             style="letter-spacing:0.1em; line-height:1.8;">High-Speed Elevators &amp;<br />Power Backup
                         </p>
                     </div>
                     ...
                     <div
                         ...
                         <p class="text-white text-xs font-light uppercase opacity-80"
                             style="letter-spacing:0.1em; line-height:1.8;">Convenient Retail and<br />Dining Spaces Nearby
                         </p>
                     </div>
     ...
     @if ($sliderTotal > 0)
         <section class="relative z-10 w-full overflow-hidden py-10 lg:py-20" style="background:#fff; min-height: 500px;">
             ...
             <div class="absolute top-0 right-0 pointer-events-none select-none overflow-hidden" style="z-index:0;">
                 <span
                     style="font-family:'Cormorant Garamond',serif; font-size:clamp(100px,20vw,280px); font-weight:700; color:rgba(0,0,0,0.05); white-space:nowrap; line-height:1;">Gallery</span>
             </div>
             ...
             <div class="relative z-10 w-full flex items-start gap-2 lg:gap-3 overflow-hidden px-0"
                 ...
                 <div class="flex-1 overflow-hidden cursor-pointer relative group"
                     style="height: 100%; align-self: flex-start;" onclick="galleryOpenLightbox(galleryState.active)">
                     <img id="centerImg" src="" alt="" class="w-full h-full object-cover block"
                     ...
                     <div
                         ...
                         <div
                             class="opacity-0 group-hover:opacity-100 transition-all duration-300 bg-white/20 backdrop-blur-sm rounded-full p-3">
             ...
             <div class="relative z-10 flex items-center gap-6 mt-10 px-6 lg:px-16">
                 ...
                 <div class="w-32 lg:w-56 h-[1px] bg-gray-400 relative flex-shrink-0">
                     <div id="galleryProgress" class="absolute left-0 top-0 h-[1px] bg-black transition-all duration-700"
                         style="width:0%;"></div>
                 </div>

                 <!-- Counter -->
                 <span id="galleryCounter" class="text-xs tracking-widest text-gray-500 flex-shrink-0"
         ...
         <!-- ===== LIGHTBOX ===== -->
         <div id="galleryLightbox" class="fixed inset-0 z-[9999] items-center justify-center"
