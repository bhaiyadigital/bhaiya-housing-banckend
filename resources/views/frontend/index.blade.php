    ...
    @php
        ...
        $schema = [
            ...
            'projectListing' => [
                ...
                'itemListElement' => isset($featuredProjects)
                    ? $featuredProjects
                        ->map(
                            fn($project, $i) => [
                                '@type' => 'ListItem',
            ...
            'newsEventList' => [
                ...
                'url' => url('/event'),
                'itemListElement' => isset($newsEvents)
                    ? collect($newsEvents)
                        ->map(
                            fn($item, $i) => [
                                '@type' => 'ListItem',
                ...
                'mainEntity' => [
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' =>
                                'We specialize in constructing exquisite residential homes, luxury apartments, and modern commercial spaces across Bangladesh, blending prestige and elegance.',
                        ],
                    ],
                    [
                        '@type' => 'Question',
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' =>
                                'Since 2012, Bhaiya Housing—a proud part of the Bhaiya Group—has been redefining modern infrastructure with over a decade of expertise.',
                        ],
                    ],
                    [
                        '@type' => 'Question',
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' =>
                                'Yes! We partner with landowners through joint ventures to transform properties into landmark developments. Visit our Landowner Contact page to get started.',
                        ],
                    ],
                    [
                        '@type' => 'Question',
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' =>
                                'Absolutely. We guarantee on-schedule completion, respecting your timelines without compromising on quality or premium materials.',
                        ],
                    ],
                ],
            ],
            ...
            <div class="absolute md:ml-32 bottom-4 md:bottom-10 left-0 right-0 z-20 px-4 md:px-0 md:left-10">
                <div class="flex gap-3 md:gap-5 overflow-x-auto scrollbar-hide  pb-1 md:p-4 md:overflow-visible">
                    ...
                    @foreach ($featuredProjects as $i => $project)
                        <div class="thumb-item {{ $i === 0 ? 'active' : '' }}  cursor-pointer overflow-visible relative flex-shrink-0"
                            style="
                        ...
                        "
                            ...
                            {{-- Progress Bar --}}
                            <div class="progress-bar absolute left-0 h-[2px] bg-white z-10 {{ $i === 0 ? '' : 'hidden' }}"
