    ...
    public function boot(): void
    {
        ...
        $contents = [
            ...
            'project' => [
                ...
                'body'             => ['label' => 'Description animated', 'required' => false],
                'body_2'           => ['label' => 'Description Box 2 animated', 'required' => false],
                'body_4'           => ['label' => 'Description static box', 'required' => false],
            ...
            'partners' => [
                ...
                'img_paths'         => ['label' => 'Landowner Box Background Image',                   'required' => false],
                'meta_title'       => ['label' => 'Meta Title', 'required' => false],
                'meta_description' => ['label' => 'Meta Description', 'required' => false],
                'meta_keywords'    => ['label' => 'Meta Keywords', 'required' => false],
                'status'           => ['label' => 'Status',                                          'required' => true],
            ...
            'settings' => [
                ...
                'body_3'   => ['label' => 'Context Text', 'required' => false],
            ...
            'meta_info' => [
                ...
                'body'             => ['label' => 'Content Text', 'required' => false],
                'body_2'           => ['label' => 'Content Text 1', 'required' => false],
                'body_3'           => ['label' => 'Content Text 2', 'required' => false],
                'body_4'           => ['label' => 'Content Text 3', 'required' => false],
                'meta_title'       => ['label' => 'Meta Title', 'required' => false],
                'meta_description' => ['label' => 'Meta Description', 'required' => false],
                'meta_keywords'    => ['label' => 'Meta Keywords', 'required' => false],
                'status'           => ['label' => 'Status', 'required' => true],
